...
class RemediationStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, 
        ...
        decision_lambda = lambda_.Function(
            ...
            handler="handler.lambda_handler",
            code=lambda_.Code.from_asset("lambdas/decision_engine"),
        ...
        s3_remediation_lambda = lambda_.Function(
            ...
            handler="handler.lambda_handler",
            handler="handler.lambda_handler",
            code=lambda_.Code.from_asset("lambdas/remediation/s3"),
        ...
        iam_remediation_lambda = lambda_.Function(
            ...
            handler="handler.lambda_handler",
            handler="handler.lambda_handler",
            code=lambda_.Code.from_asset("lambdas/remediation/iam"),
            timeout=Duration.seconds(30),
            timeout=Duration.seconds(30),
            memory_size=256,
        ...
        sg_remediation_lambda = lambda_.Function(
            ...
            handler="handler.lambda_handler",
            handler="handler.lambda_handler",
            code=lambda_.Code.from_asset("lambdas/remediation/security_group"),
            timeout=Duration.seconds(30),
            timeout=Duration.seconds(30),
            memory_size=256,
